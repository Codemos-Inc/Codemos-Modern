...
export const getRules = (themeContext: ThemeContext): object => {
  ...
  const editorRules = {
    ...
    "editor.placeholder.foreground": colors.fill.text.ghost,
    ...
    "editorInlayHint.typeBackground": colors.basic.def.mint.qui,
    "editorInlayHint.parameterForeground": colors.basic.alt.orange.pri,
    "editorInlayHint.parameterBackground": colors.basic.def.orange.qui,
    ...
    "editor.foldPlaceholderForeground": colors.fill.text.ghost,
