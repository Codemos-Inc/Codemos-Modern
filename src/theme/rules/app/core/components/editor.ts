...
export const getRules = (themeContext: ThemeContext): object => {
  ...
  const rules = {
    ...
    "editorInlayHint.parameterForeground": styles.code.scope10,
    "editorInlayHint.typeBackground": matchHex9Alpha(styles.code.scope03, styles.basic.neutral.qui),
    "editorInlayHint.typeForeground": styles.code.scope03,
