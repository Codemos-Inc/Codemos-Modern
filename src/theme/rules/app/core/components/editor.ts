...
export const getRules = (themeContext: ThemeContext): object => {
  ...
  const rules = {
    ...
    "editorInlayHint.parameterBackground": matchHex9Alpha(styles.code.b2, styles.basic.neutral.qui),
    "editorInlayHint.parameterForeground": styles.code.b2,
    "editorInlayHint.typeBackground": matchHex9Alpha(styles.code.a4, styles.basic.neutral.qui),
    "editorInlayHint.typeForeground": styles.code.a4,
