...
export const getRules = (themeContext: ThemeContext): object => {
  ...
  const rules = {
    ...
    "tab.selectedBorderTop": colors.stroke.divider.default,
    "tab.selectedBackground": colors.fill.tab.activeFocused,
    "tab.selectedForeground": colors.fill.text.pri,
  ...
  if (design === "minimal") {
    ...
    rules["tab.activeBorder"] = colors.bg.solid.canvas;
    rules["tab.unfocusedActiveBorder"] = colors.bg.solid.canvas;
  } else if (design === "flat") {
    rules["editorGroupHeader.border"] = TRANSPARENT;
    rules["tab.activeBorder"] = colors.bg.solid.canvas;
    rules["tab.unfocusedActiveBorder"] = colors.bg.solid.canvas;
