...
async function applyTheme(colors: typeof darkColors | typeof lightColors, isDarkMode: boolean) {
  const themeObject = {
    ...
    colors: {
      ...
      "editorHint.foreground": colors.BASIC_DEF_MINT.pri,
      ...
      "gitlens.graphLane1Color": colors.BASIC_DEF_RED.pri,
      "gitlens.graphLane2Color": colors.BASIC_DEF_ORANGE.pri,
      "gitlens.graphLane3Color": colors.BASIC_DEF_YELLOW.pri,
      "gitlens.graphLane4Color": colors.BASIC_DEF_GREEN.pri,
      "gitlens.graphLane5Color": colors.BASIC_DEF_MINT.pri,
      "gitlens.graphLane6Color": colors.BASIC_DEF_BLUE.pri,
      "gitlens.graphLane7Color": colors.BASIC_DEF_PURPLE.pri,
      "gitlens.graphLane8Color": colors.BASIC_DEF_PINK.pri,
      ...
      "gitlens.graphScrollMarkerUpstreamColor": colors.BASIC_ALT_GREEN.sec,
      "gitlens.gutterBackgroundColor": colors.BG_SOLID.surface,
      "gitlens.gutterForegroundColor": colors.FILL_TEXT.sec,
      "gitlens.gutterUncommittedForegroundColor": colors.BASIC_ALT_BLUE.pri,
      "gitlens.lineHighlightBackgroundColor": colors.BASIC_NEUTRAL.sep,
      "gitlens.lineHighlightOverviewRulerColor": colors.BASIC_NEUTRAL.sep,
      "gitlens.mergedPullRequestIconColor": colors.BASIC_DEF_PURPLE.pri,
      "gitlens.openPullRequestIconColor": colors.BASIC_DEF_GREEN.pri,
      "gitlens.openAutolinkedIssueIconColor": colors.BASIC_DEF_GREEN.pri,
      "gitlens.trailingLineBackgroundColor": colors.TRANSPARENT.value,
      "gitlens.trailingLineForegroundColor": colors.FILL_TEXT.ghost,
      "gitlens.unpublishedChangesIconColor": colors.BASIC_ALT_GREEN.pri,
      "gitlens.unpublishedCommitIconColor": colors.BASIC_DEF_GREEN.pri,
      "gitlens.unpulledChangesIconColor": colors.BASIC_DEF_ORANGE.pri,
      // icon | @{VSCODE}
      ...
      "remoteHub.decorations.addedForegroundColor": colors.BASIC_DEF_GREEN.pri,
      "remoteHub.decorations.conflictForegroundColor": colors.BASIC_DEF_ORANGE.pri,
      "remoteHub.decorations.deletedForegroundColor": colors.BASIC_DEF_RED.pri,
      "remoteHub.decorations.ignoredResourceForeground": colors.FILL_TEXT.disabled,
      "remoteHub.decorations.modifiedForegroundColor": colors.BASIC_DEF_BLUE.pri,
      "remoteHub.decorations.incomingAddedForegroundColor": colors.BASIC_ALT_GREEN.pri,
      "remoteHub.decorations.incomingDeletedForegroundColor": colors.BASIC_ALT_RED.pri,
      "remoteHub.decorations.incomingModifiedForegroundColor": colors.BASIC_ALT_BLUE.pri,
      "remoteHub.decorations.incomingRenamedForegroundColor": colors.BASIC_ALT_YELLOW.pri,
