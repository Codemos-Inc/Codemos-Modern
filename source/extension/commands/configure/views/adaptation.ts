...
export const adaptationView = async (
  variant: Variant,
  accentColor: string,
): Promise<string | null> => {
  ...
  quickPick.items = [
    ...
    },
    {
      ...
      iconPath: Uri.file(`${__dirname}/../../res/icons/${variant}/palette_accent.svg`),
    },
    {
      _color: "",
    ...
    },
    {
      ...
      iconPath: Uri.file(`${__dirname}/../../res/icons/${variant}/palette_brown.svg`),
    },
    {
      _color: "red",
      ...
      iconPath: Uri.file(`${__dirname}/../../res/icons/${variant}/palette_red.svg`),
    },
    {
      _color: "orange",
      ...
      iconPath: Uri.file(`${__dirname}/../../res/icons/${variant}/palette_orange.svg`),
    },
    {
      _color: "yellow",
      ...
      iconPath: Uri.file(`${__dirname}/../../res/icons/${variant}/palette_yellow.svg`),
    },
    {
      _color: "green",
      ...
      iconPath: Uri.file(`${__dirname}/../../res/icons/${variant}/palette_green.svg`),
    },
    {
      _color: "mint",
      ...
      iconPath: Uri.file(`${__dirname}/../../res/icons/${variant}/palette_mint.svg`),
    },
    {
      _color: "blue",
      ...
      iconPath: Uri.file(`${__dirname}/../../res/icons/${variant}/palette_blue.svg`),
    },
    {
      _color: "purple",
      ...
      iconPath: Uri.file(`${__dirname}/../../res/icons/${variant}/palette_purple.svg`),
    },
    {
      _color: "pink",
      ...
      iconPath: Uri.file(`${__dirname}/../../res/icons/${variant}/palette_pink.svg`),
    },
  ];
